...
.. code-block:: bash
    ...
    # Run the script
    ./isaaclab.sh -p scripts/tutorials/03_envs/create_rexai_base_env.py --num_envs 32
...
parser = argparse.ArgumentParser(description="Tutorial on creating a bipedal trex base environment.")
...
from isaaclab_assets.robots.rexai import REXAI_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # add robot
    robot: ArticulationCfg = REXAI_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class RexAIEnvCfg(ManagerBasedEnvCfg):
